...
<section class="darion-gradient-bg py-20 px-6 relative overflow-hidden">
    ...
    <div class="max-w-6xl mx-auto relative z-10 text-center animate-fade-in">
        <div class="inline-flex items-center gap-2 mb-4 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-darion-lg">
            ...
            <span class="text-sm font-medium">Trusted Personal Loan Services</span>
        </div>
        ...
        <p class="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto mb-8 leading-relaxed">
            Fast, hassle-free loans for emergencies, travel, shopping, medical needs, and more.
            Get approved within 24-48 hours with minimal documentation.
        </p>
...
<section class="max-w-6xl mx-auto px-6 py-20">
    ...
    <div id="features" class="grid md:grid-cols-3 gap-8 mb-20 animate-slide-up">
        <div class="feature-card glass-card p-8 border border-darion-border rounded-darion-lg hover:border-darion-primary/50 transition-all duration-300">
            ...
            <h3 class="text-xl font-semibold mb-3">Fast Approvals</h3>
            <p class="text-darion-text-muted leading-relaxed">
                Loan applications processed in 24-48 hours with real-time tracking and updates.
            </p>
        </div>
        ...
        <div class="feature-card glass-card p-8 border border-darion-border rounded-darion-lg hover:border-darion-primary/50 transition-all duration-300">
            ...
            <h3 class="text-xl font-semibold mb-3">Secure & Confidential</h3>
            <p class="text-darion-text-muted leading-relaxed">
                Your data and documents remain encrypted and safe with bank-level security.
            </p>
        </div>
    </div>
    ...
    <div class="glass-card p-10 rounded-darion-lg border border-darion-border mb-16 animate-slide-up">
        <h2 class="text-3xl font-light mb-6 text-white">Loan Overview</h2>
        <p class="text-darion-text-muted text-lg leading-relaxed mb-6">
            Darion Finance provides instant Personal Loan services with fast approval,
            minimal documentation, and transparent processing. Whether you need funds
            for travel, medical emergencies, shopping, home needs, or education —
            we are here to help with competitive rates and flexible repayment options.
        </p>
        
        <!-- Loan Details -->
        <div class="grid md:grid-cols-3 gap-6 mt-8">
            <div class="bg-darion-panel/50 p-6 rounded-darion-sm border border-darion-border">
                <div class="text-2xl font-light text-darion-primary-light mb-2">₹50,000 - ₹5 Lakhs</div>
        ...
        <div class="animate-slide-up">
            ...
            <div class="space-y-4">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <div class="font-medium text-white">Age between 21 to 60 years</div>
                        <div class="text-sm text-darion-text-muted mt-1">Both salaried and self-employed individuals</div>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <div class="font-medium text-white">Aadhaar & PAN Card mandatory</div>
                        <div class="text-sm text-darion-text-muted mt-1">Government issued identity proof required</div>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <div class="font-medium text-white">Bank Statement (6 months)</div>
                        <div class="text-sm text-darion-text-muted mt-1">Regular income proof from any bank</div>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <div class="font-medium text-white">Stable income source</div>
                        <div class="text-sm text-darion-text-muted mt-1">Minimum ₹15,000 monthly income</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center gap-3 p-4 bg-darion-panel/30 rounded-darion-sm border border-darion-border">
                    ...
                    <div>
                        ...
                        <div class="text-sm text-darion-text-muted">Last 6 months PDF</div>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3 p-4 bg-darion-panel/30 rounded-darion-sm border border-darion-border">
                    ...
                    <div>
                        <div class="font-medium text-white">Income Proof</div>
                        <div class="text-sm text-darion-text-muted">Salary slip or Income Certificate</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="text-center animate-slide-up">
        <div class="glass-card p-12 rounded-darion-lg border border-darion-border">
            <h2 class="text-3xl font-light mb-4 text-white">Ready to Apply?</h2>
            <p class="text-darion-text-muted text-lg mb-8 max-w-2xl mx-auto">
                Start your personal loan application now. It takes less than 5 minutes to complete.
            </p>
            ...
            <div class="mt-8 text-sm text-darion-text-muted flex items-center justify-center gap-2">
                ...
                <span>100% Secure Application • No Credit Check Required</span>
            </div>
        </div>
    </div>
